...
def _get_tag_checkbox_updates(caption, quick_tags, quick_tags_set):
    ...
    return gr.CheckboxGroup.update(choices=caption_tags_all, value=caption_tags_have)
...
def update_image_tags(
    quick_tags_text, selected_tags, image_file, images_dir, caption_ext, auto_save
):
    ...
    with gr.Tab("Manual Captioning"):
        ...
        for _ in range(IMAGES_TO_SHOW):
            with gr.Row(visible=False) as row:
                ...
                save_button = gr.Button("💾", elem_id="open_folder_small", visible=False)
                ...
                save_button.click(
                    save_caption,
                    inputs=[image_caption_text, caption_ext, image_file, images_dir],
                )
        ...
        load_images_button.click(
            load_images,
            inputs=[images_dir, caption_ext, loaded_images_dir, page, max_page],
